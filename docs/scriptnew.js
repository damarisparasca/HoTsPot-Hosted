document.addEventListener("DOMContentLoaded", function () {
    ...
    calculateButton.addEventListener("click", function () {
      ...
      let waterCreditInfo = `<h3>Water Credits</h3><br><span style="font-size: 50px; position: relative; top: -40px;">${creditAmount}</span>`;
    ...
    document.getElementById("thres").textContent = `Total emissions threshold: ${nitrogenThreshold.toFixed(2)} kg/year`;
    ...
    document.querySelector(".cloud-thres").style.display = "block";
